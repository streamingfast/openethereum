...
pub type ExecTrapResult<T, DM> = TrapResult<T, Box<dyn ResumeCall<DM>>, Box<dyn ResumeCreate<DM>>>;
pub type ExecTrapError<DM> = TrapError<Box<dyn ResumeCall<DM>>, Box<dyn ResumeCreate<DM>>>;
